...
#### 2.	And that's it. Open browser and go to [http://localhost:3000/items](http://localhost:3000/items)  
...
To tweak the front-end, please open a terminal, change directory to the Angular src folder `/ng-src`, then run `ng serve --open`. This will start another server and open `http://localhost:4200`. Now if you do some change in `/ng-src`, the change will automatically reflect at this address. 
